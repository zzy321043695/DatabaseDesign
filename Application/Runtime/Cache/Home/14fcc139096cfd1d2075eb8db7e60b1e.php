			...
			<div class="row">
				<div class="col-sm-9 col-md-9">
					...
					<div id="property-gallery" class="cbp listing1">
						<?php if(is_array($result['listMagazine'])): $i = 0; $__LIST__ = $result['listMagazine'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--
                              <?php if($vo["classification"] == 1): ?>class= "cbp-item sale"<?php endif; ?>
                              <elseif condition = "$vo.classification eq 2">class= "cbp-item latest"</elseif>
                            <esle condition = "$vo.classification eq 3">class= "cbp-item rent"</esle>
                            -->
								...
								<div class="property_item">
									<div class="image">
										...
										<div class="price clearfix">
											<span class="tag pull-right"><?php echo ($vo["price"]); ?> Per Month</span>
										</div>
					...
					<div class="magazine-list">
						<?php if(is_array($result['listMagazine'])): $i = 0; $__LIST__ = $result['listMagazine'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
								<dt><?php echo ($vo["title"]); ?></dt>
								<dd class="magazine-img">
									<a href="/index.php?c=detail&id=<?php echo ($vo["magazine_id"]); ?>"><img width="200" height="120" src="<?php echo ($vo["thumb"]); ?>" alt="<?php echo ($vo["title"]); ?>"></a>
								</dd>
								<dd class="magazine-intro">
									<?php echo ($vo["description"]); ?>
								</dd>
								<dd class="magazine-info">
