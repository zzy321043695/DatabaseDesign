    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/admin.php?c=content">杂志管理</a>
            </li>
            <li class="active">
              <i class="fa fa-edit"></i> 杂志添加
            </li>
          </ol>
        </div>
      </div>
        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">杂志名:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($magazine["title"]); ?>" type="text" name="title" class="form-control" id="inputname" placeholder="请填写杂志名">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">主编:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($magazine["small_title"]); ?>" type="text" name="small_title" class="form-control" id="inputname" placeholder="请填写主编">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                ...
                <img style="display: none" id="upload_org_code_img" src="<?php echo ($magazine["thumb"]); ?>" width="150" height="150">
                <input id="file_upload_image" name="thumb" type="hidden" multiple="true" value="<?php echo ($magazine["thumb"]); ?>">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="title_font_color">
                  <option value="">==请选择颜色==</option>
                    <?php if(is_array($titleFontColor)): foreach($titleFontColor as $key=>$color): ?><option value="<?php echo ($key); ?>" <?php if($key == $magazine['title_font_color']): ?>selected="selected"<?php endif; ?>><?php echo ($color); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  ...
                  <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?><option value="<?php echo ($sitenav["menu_id"]); ?>" <?php if($sitenav['menu_id'] == $magazine['catid']): ?>selected="selected"<?php endif; ?>><?php echo ($sitenav["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="copyfrom">
                  <?php if(is_array($copyfrom)): foreach($copyfrom as $key=>$cfrom): ?><option value="<?php echo ($key); ?>" <?php if($key == $magazine['copyfrom']): ?>selected="selected"<?php endif; ?>><?php echo ($cfrom); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <textarea class="input js-editor" id="editor_singcms" name="content" rows="20" ><?php echo ($magazine["content"]); ?></textarea>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">简易描述:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($magazine["keywords"]); ?>" type="text" class="form-control" name="keywords" id="inputPassword3" placeholder="请填写简易描述">
              </div>
            </div>
            <div class="form-group">
            ...
            <input type="hidden" name="magazine_id" value="<?php echo ($magazine["magazine_id"]); ?>"/>
...
<script>
  var thumb = "<?php echo ($magazine["thumb"]); ?>";
  if(thumb) {
