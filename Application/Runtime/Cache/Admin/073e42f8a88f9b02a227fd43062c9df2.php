        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i>  <a href="/admin.php?c=admin">订单管理</a>
                        </li>
                        <li class="active">
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($vo["magazine_name"]); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["id"]); ?>" id="singcms-delete"  attr-a="admin" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a>
                                        </td>
...
<script>
    var SCOPE = {
        ...
        'edit_url' : '/admin.php?c=orderManager&a=edit',
        'set_status_url' : '/admin.php?c=orderManager&a=setStatus',
        'index_url' : '/admin.php?c=orderManager',
