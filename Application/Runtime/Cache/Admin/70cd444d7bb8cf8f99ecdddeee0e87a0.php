                    ...
                    <div class="table-responsive">
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <tbody>
                                <?php if(is_array($discounts)): $i = 0; $__LIST__ = $discounts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" attr-id="<?php echo ($vo["user_id"]); ?>" id="singcms-delete"  attr-a="admin" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a>
                                        </td>
...
<script>
    var SCOPE = {
        'add_url' : '/admin.php?c=discount&a=add',
